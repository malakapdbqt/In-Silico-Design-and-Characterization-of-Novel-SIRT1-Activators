...
# by inserting '_dock6_b2' before the .mol2 extension.
# It uses a shell loop to avoid the "Argument list too long" error.

for f in separated_mol2/*.mol2; do
...
echo "Renaming complete in the separated_mol2 directory."
